...
void main() {
  ...
  test('the values of pi are 3.0, 3.1, 3.14, 3.141 and 3.1415', () async {
    ...
    await driver.waitFor(find.text('The latest known value of pi is 3.145'));
  });

  test('multiplying 5 and 10 shows 50', () async {
    await driver.tap(find.byValueKey('textField_top_multiplied_by'));
    await driver.enterText('5');
    await driver.tap(find.byValueKey('textField_bottom_multiplied_by'));
